...
unsigned int loadTexture(const char* path, bool);
...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Learn Screen Space Ambient Occlusion", NULL, NULL);
    ...
    Shader shaderGeometryPass("ssao_geometry.vert", "ssao_geometry.frag");   glObjectLabel(GL_PROGRAM, shaderGeometryPass.ID, -1, "shaderGeometryPass");
    ...
    Shader shaderSSAOBlur("ssao.vert", "ssao_blur.frag");   glObjectLabel(GL_PROGRAM, shaderSSAOBlur.ID, -1, "shaderSSAOBlur");
    ...
    glGenTextures(1, &gPositionDepth);  glObjectLabel(GL_TEXTURE, gPositionDepth, -1, "gPositionDepth");
    ...
    // - Normal color buffer
    glGenTextures(1, &gNormal); glObjectLabel(GL_TEXTURE, gNormal, -1, "gNormal");
    ...
    // - Albedo color buffer
    glGenTextures(1, &gAlbedo); glObjectLabel(GL_TEXTURE, gAlbedo, -1, "gAlbedo");
