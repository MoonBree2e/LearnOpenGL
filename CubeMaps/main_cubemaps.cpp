...
int main()
{
    ...
    Shader boxReflectShader("boxReflect.vert", "boxReflect.frag");
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(cubePosNormal), &cubePosNormal, GL_STATIC_DRAW);
    glEnableVertexAttribArray(0);
