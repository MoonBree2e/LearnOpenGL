...
int main()
{
    ...
    GLuint diffuseMap = loadTexture("../Assets/toy_box_diffuse.png");
    GLuint normalMap = loadTexture("../Assets/toy_box_normal.png");
    GLuint heightMap = loadTexture("../Assets/toy_box_disp.png");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::mat4 model(1.0f);
        // model = glm::rotate(model, (GLfloat)glfwGetTime() * -10, glm::normalize(glm::vec3(1.f, 0, 1.f)));
...
void processInput(GLFWwindow* window)
{
    ...
    if (glfwGetKey(window, GLFW_KEY_U) == GLFW_PRESS && !parallaxKeyPressed)
    {
