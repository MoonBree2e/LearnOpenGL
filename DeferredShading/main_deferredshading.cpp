...
int main()
{
    ...
    // - 位置颜色缓冲
    glGenTextures(1, &gPosition); glObjectLabel(GL_TEXTURE, gPosition, -1, "gPosition");
    ...
    // - 颜色 + 镜面颜色缓冲
    glGenTextures(1, &gAlbedoSpec); glObjectLabel(GL_TEXTURE, gAlbedoSpec, -1, "gAlbedoSpec");
