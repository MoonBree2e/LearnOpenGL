...
public:
	 ...
	 */
	std::shared_ptr<Framebuffer> getExtraFramebuffer(const std::string&, ExtraFramebufferOption option = ExtraFramebufferOption::Rgba32fDepth) const;
...
class TurntableCamera : public GrCamera {
public:
	TurntableCamera();
