...
int main()
{
    ...
    // -------------------------
    Shader redShader("cube.vert", "red.frag");
    Shader greenShader("cube.vert", "green.frag");
    Shader blueShader("cube.vert", "blue.frag");
    Shader yellowShader("cube.vert", "yellow.frag");
